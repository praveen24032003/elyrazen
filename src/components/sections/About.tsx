...
export default function About() {
  return (
    <section id="philosophy" className="py-24 px-2 sm:px-0 border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="flex-1">
            <h2 className="text-sm font-bold uppercase tracking-[0.2em] gold-text mb-6">Our Philosophy</h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={text} className="flex items-center gap-4 group">
                  <div className="w-6 h-6 rounded-full gold-bg flex items-center justify-center transition-transform group-hover:scale-110 shadow-lg shadow-black/10 border gold-border">
            ...
            <div className="mt-12 group cursor-default">
              ...
              <p className="text-[10px] font-bold gold-text uppercase tracking-widest">
          ...
          <div className="flex-1 w-full flex flex-col gap-6">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-white rounded-[40px] p-10 relative overflow-hidden group border border-gray-200 shadow-sm"
            >
              <div className="relative z-10">
                <blockquote className="text-xl sm:text-2xl font-medium italic text-black mb-10 leading-relaxed">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="gold-text text-[10px] font-bold uppercase tracking-tight">Premium Client Case Study</div>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-[rgba(212,175,55,0.18)] rounded-full blur-3xl group-hover:scale-125 transition-transform duration-[2000ms]"></div>
            </motion.div>
          </div>
        </div>
      </div>
